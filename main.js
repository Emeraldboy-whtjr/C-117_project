...
document.getElementById("sketchlbl").innerHTML = "Sketch to be drawn: " + sketch;
...
function draw(){
    ...
    check_sketch();
    if (drawn_sketch == sketch){// ma'am this line makes no sense to me as becasue the drawn sketch is an empty variable that isn't bieng used in project C-118, so is this suppossed to mean that var skecth is empty?
        answer_holder = "set";
        score++;
...
function gotresult(error,results){
    if (error){
        ...
        document.getElementById("drawnsketch").innerHTML = "Sketch Drawn: " + drawn_sketch;
...
function check_sketch(){
    timer_counter++;
    document.getElementById("timer").innerHTML = "Timer: " + timer_counter + " ms";
